...
// known issue: this function might fail itself with "too many open files" error
// the issue does not always appear and seems to be highly dependent on the relative task execution speed vs the new worker start intervals
// the following parameters seem to be stable in Ubuntu 16.04 VM with two cores.
