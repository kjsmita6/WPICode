...
#----------------------------------------------------
'''
    (Compute Players' Batting Average) Given a dataframe (X6) of all the candidate players,
    compute the Batting Average (BA) of each player and insert a new column named 'BA' to
    store the data. 
    ---- Inputs: --------
...
def compute_players_BA(X6):
    ...
    X6.insert(len(X6.columns), 'BA', X6['H'] / X6['AB'])
    #########################################
    #-----------------
    '''  
...
def compute_players_OBP(X7):
    #########################################
    ## INSERT YOUR CODE HERE (4 points)
    X7.insert(len(X7.columns), 'OBP', (X7['H'] + X7['BB'] + X7['HBP']) / (X7['AB'] + X7['BB'] + X7['HBP'] + X7['SF']))
    #########################################
    #-----------------
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
...
def compute_players_1B(X8):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    X8.insert(len(X8.columns), '1B', X8['H'] - X8['2B'] - X8['3B'] - X8['HR'])
    #########################################
    #-----------------
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
...
def compute_players_TB(X9):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    X9.insert(len(X9.columns), 'TB', X9['1B'] * 1 + X9['2B'] * 2 + X9['3B'] * 3 + X9['HR'] * 4)
    #########################################
    #-----------------
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
...
def compute_players_SLG(X10):
    #########################################
    ## INSERT YOUR CODE HERE (4 points)
    X10.insert(len(X10.columns), 'SLG', X10['TB'] / X10['AB'])
    #########################################
    #-----------------
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
