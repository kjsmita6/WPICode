...
def remove_sink_nodes(A):
    #########################################
    ## INSERT YOUR CODE HERE (5 points)
    zeros = np.where((A == 0).all(axis=0))[0]
    A[:, zeros] = 1
    #########################################
    return A
    #-----------------
...
def compute_S(A_):
    #########################################
    ## INSERT YOUR CODE HERE (5 points)
    out = count_out_links(A_)
    S = np.where(A_ == 1, 1.0 / out, A_)
    #########################################
    return S
    #-----------------
    '''  
...
def add_column_pagerank(X2, x):
    #########################################
    ## INSERT YOUR CODE HERE (5 points)
    X2.insert(len(X2.columns), 'PageRank', x)
    #########################################
    return X2
    #-----------------
    '''  
