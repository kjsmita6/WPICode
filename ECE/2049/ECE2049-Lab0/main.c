...

{
    ...
    unsigned char kyle[5] = "Kyle\0";
    unsigned char sabrina[8] = "Sabrina\0";

    Graphics_drawStringCentered(&g_sContext, kyle, AUTO_STRING_LENGTH, 45, 15, TRANSPARENT_TEXT);
    Graphics_drawStringCentered(&g_sContext, sabrina, AUTO_STRING_LENGTH, 45, 25, TRANSPARENT_TEXT);


    // Write some text to the display
    //Graphics_drawStringCentered(&g_sContext, "Welcome", AUTO_STRING_LENGTH, 60, 15, TRANSPARENT_TEXT);
    //Graphics_drawStringCentered(&g_sContext, "to", AUTO_STRING_LENGTH, 48, 2, TRANSPARENT_TEXT);
