...
fonts/fontfixed6x8.obj: ../fonts/fontfixed6x8.c $(GEN_OPTS) | $(GEN_HDRS)
	...
	"C:/ti/ccsv8/tools/compiler/ti-cgt-msp430_18.1.3.LTS/bin/cl430" -vmspx --data_model=restricted --use_hw_mpy=F5 --include_path="C:/ti/ccsv8/ccs_base/msp430/include" --include_path="R:/ECE 2049 LABS/ECE2049_Lab2_1/grlib" --include_path="R:/ECE 2049 LABS/ECE2049_Lab2_1" --include_path="C:/ti/ccsv8/tools/compiler/ti-cgt-msp430_18.1.3.LTS/include" --advice:power=all --define=__MSP430F5529__ -g --printf_support=minimal --diag_warning=225 --diag_wrap=off --display_error_number --silicon_errata=CPU21 --silicon_errata=CPU22 --silicon_errata=CPU23 --silicon_errata=CPU40 --preproc_with_compile --preproc_dependency="fonts/fontfixed6x8.d_raw" --obj_directory="fonts" $(GEN_OPTS__FLAG) "$<"
