...
HD_PWD='R:/ECE 2029 Lab 2/Lab2/Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and_or_not_xor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and_or_not_xor.tcl
