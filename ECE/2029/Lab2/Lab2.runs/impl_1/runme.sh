...
HD_PWD='R:/ECE 2029 Lab 2/Lab2/Lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log and_or_not_xor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source and_or_not_xor.tcl -notrace
