...
HD_PWD='R:/ECE/ECE2029_FADisp/ECE2029_FADisp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_Adder_Disp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Full_Adder_Disp.tcl
