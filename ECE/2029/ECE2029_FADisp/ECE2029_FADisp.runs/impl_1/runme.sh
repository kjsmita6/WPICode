...
HD_PWD='R:/ECE/ECE2029_FADisp/ECE2029_FADisp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_Adder_Disp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Full_Adder_Disp.tcl -notrace
