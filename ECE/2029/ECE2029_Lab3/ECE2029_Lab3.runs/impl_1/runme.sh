...
HD_PWD='R:/ECE/ECE2029_Lab3/ECE2029_Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_seg_Disp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Seven_seg_Disp.tcl -notrace
