...
HD_PWD='R:/ECE/ECE2029_Lab3/ECE2029_Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_seg_Disp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Seven_seg_Disp.tcl
