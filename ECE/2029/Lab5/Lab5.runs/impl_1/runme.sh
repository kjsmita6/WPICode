...
HD_PWD='R:/ECE/Lab5/Lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log garage_occupancy_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source garage_occupancy_top.tcl -notrace
