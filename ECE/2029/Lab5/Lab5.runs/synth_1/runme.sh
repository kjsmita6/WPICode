...
HD_PWD='R:/ECE/Lab5/Lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log garage_occupancy_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source garage_occupancy_top.tcl
