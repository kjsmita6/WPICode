...
HD_PWD='R:/ECE/ECE2029_2sComp/ECE2029_2sComp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_Adder_4bit_2sComplement_Lab3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Full_Adder_4bit_2sComplement_Lab3.tcl -notrace
