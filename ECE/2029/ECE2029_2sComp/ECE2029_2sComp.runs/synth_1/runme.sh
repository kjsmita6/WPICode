...
HD_PWD='R:/ECE/ECE2029_2sComp/ECE2029_2sComp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_Adder_4bit_2sComplement_Lab3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Full_Adder_4bit_2sComplement_Lab3.tcl
